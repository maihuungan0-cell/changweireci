...
export const fetchDailyRecommendations = async (): Promise<RecommendTopic[]> => {
  ...
  try {
    const response = await ai.models.generateContent({
      ...
      contents: "角色： 顶尖内容策略专家，擅长从平凡生活中挖掘“令人倒吸一口凉气”的真实痛点。任务： 生成16个能让用户产生“他在监控我的生活”错觉的创新专题。优化策略：切口极小、反差感、情绪钩子： 必须包含：尴尬感、紧迫感、被窥视感、或对未来不确定性的微小恐惧。约束：格式：【标题】 【20-30字详细解说】，中间留白。风格：50%【私信焦虑风】（模拟密友，口语化，带称呼）； 50%【系统干预风】（模拟官方法律/技术预警，冷静专业）。拒绝任何宏大叙事、大道理或通用的生活百科建议。",
      config: {
